...
def train_model_qat(
    ...
    for epoch in range(num_epochs):
        ...
        #replace following with if start_qat is True
        if start_qat: #epoch >= qat_start_epoch:
            ...
            if test_accuracy > 88.0:
                ...
                print("#####################################################")
                print(f'Starting QAT training now. Epoch number: {epoch}')
                print("#####################################################")
